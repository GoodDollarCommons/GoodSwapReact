...
function App() {
   ...
   */
  async function buy() {
    const cdaiAmountinWei = web3.utils.toWei("1000", "ether").toString()
    const gdAddress = "0x5810950BF9184F286f1C33b2cf80533D2CB274AF" // ropsten address, for other addresses: https://docs.gooddollar.org/smart-contracts-guide/core-contracts-and-api
    ...
    try {
      ...
      await cdaiContract.methods
        .approve(gdAddress, cdaiAmountinWei)
        .send({ from: myAddress })
        .catch((e) => {
      ...
      const gdContract = new web3.eth.Contract(GoodReserveABI, gdAddress)
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>
          See our{" "}
          <a className="App-link" href="https://docs.gooddollar.com/developers" >
